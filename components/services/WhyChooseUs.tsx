  ...
  " />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        <ScrollReveal className="text-center mb-20">
          ...
          <p className="text-slate-100 mt-5 max-w-3xl mx-auto">
            COSMINNOX empowers AI and deep-tech startups with infrastructure,
            mentorship, funding access, and industry collaboration — all under
            one ecosystem.
          </p>
  ...
  {incubationPrograms.map((item, i) => {
    ...
    return (
      ...
      >
        ...
        <ScrollReveal className="text-center mb-14">
          <h3 className="text-4xl font-bold">Funding & Investment Support</h3>
          <p className="text-slate-400 mt-4 max-w-4xl mx-auto">
            We guide startups through investor readiness, pitch refinement, and due diligence while opening access to aligned capital partners.
Funding becomes a growth enabler, not a distraction.
          </p>
        </ScrollReveal>

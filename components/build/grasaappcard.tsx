...
export default function GrasaAppCard() {
  return (
    <div className="relative group max-w-3xl">
      ...
      <div
        ...
        style={{
          boxShadow: "0 0 80px -15px rgba(163,230,53,0.55)",
        }}
      />
      ...
      >
        ...
        <div className="relative h-56 w-full">
          <Image
            src="/a1.png" // 🔁 app screenshot
            alt="GRASA App Preview"
            fill
        ...
        <div className="pt-16 px-8 pb-8">
          ...
          <p className="text-white/65 leading-relaxed">
            Lifestyle & nutrition focused mobile app designed to build
            healthy habits through food intelligence and daily tracking.
          </p>
          <GlassMeta
            items={[
              "Website",
...
function ActionIcon({
  ...
  return (
    <a
      href={href}
      target="_blank"
      className="group/action flex flex-col items-center text-white mt-3"
    >
      <div
        className="

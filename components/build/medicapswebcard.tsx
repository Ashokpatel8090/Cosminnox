...
export default function MediCapsWebCard() {
  return (
    <div className="relative group max-w-3xl">
      ...
      <div
        ...
        style={{
          boxShadow: "0 0 80px -15px rgba(59,130,246,0.6)",
        }}
      />
      ...
      ">
        ...
        <div className="relative h-56 w-full">
          <Image
            src="/w1.png" // 🔁 website screenshot
            alt="MediCAPS Website Preview"
            fill
        ...
        <div className="pt-16 px-8 pb-8">
          ...
          <p className="text-white/65 leading-relaxed">
            Official healthcare platform showcasing MediCAPS services,
            features, and digital health ecosystem with a modern UI.
          </p>
        </div>
        ...
        ">
          ...
          <div className="flex justify-center gap-6 text-white/90">
            <TechIcon icon={<SiReact size={22} />} label="Next.js / React" />

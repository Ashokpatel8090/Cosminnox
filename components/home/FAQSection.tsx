...
const faqs = [
  ...
  {
    q: "Do you work with startups and enterprise clients?",
    a: "Yes! We work with organizations of all sizes, from ambitious startups to established enterprises.",
  },
  {
    q: "What technologies do you specialize in?",
    a: "We specialize in React, Next.js, Node.js, cloud platforms, and mobile development.",
  },
  {
    q: "How do you handle project communication?",
    a: "We maintain transparent communication through standups, reports, and dedicated managers.",
  },
  {
    q: "What is your engagement model?",
    a: "We offer fixed-price, time & materials, and retainer-based models.",
  },
  {
    q: "How do you ensure project quality?",
    a: "Through reviews, testing, QA, and continuous monitoring.",
  },
]
        ...
        <div className="space-y-4">
          {faqs.map((faq, index) => (
            <ScrollReveal
              ...
              delay={
                isStudent
                  ? index * 0.12   // 🧑‍🎓 slow & calm
                  : index * 0.05   // 🚀 founder fast
              }
              y={isStudent ? 16 : 28}
            >
              <details
                className={`group rounded-xl border backdrop-blur transition-all duration-300 ${
                  isStudent
                    ? "border-slate-200 bg-white"
                    : "border-blue-200/30 dark:border-blue-800/30 bg-white/70 dark:bg-slate-900/60 hover:shadow-lg"
                }`}
              >
                <summary className="flex items-center justify-between gap-4 font-semibold p-6 cursor-pointer list-none">

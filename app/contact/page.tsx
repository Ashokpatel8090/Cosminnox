...
/* ===================== LOTTIE ANIMATION ===================== */
import contactAnimation from "@/public/contact/Support.json"
      ...
      <section className="py-24 bg-gradient-to-b from-slate-50 to-white dark:from-slate-900 dark:to-slate-950">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <ScrollReveal className="text-center mb-10">
            ...
            <p className="text-xl text-slate-600 dark:text-slate-400">
              From first conversation to real-world execution, we collaborate with founders to turn bold ideas into scalable, market-ready ventures. Every message is the start of a long-term partnership, not just a reply.
            </p>
          </ScrollReveal>
          ...
          <ParallaxSection>
            <div className="glass glass-card p-10 rounded-3xl border-2 border-blue-200/30 dark:border-blue-800/30">
              <div className="grid lg:grid-cols-2 gap-12 items-center">
                ...
                <div className="relative h-[420px] lg:h-[520px] rounded-2xl overflow-hidden bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={handleChange}
                          required
                          className="w-full px-4 py-3 rounded-lg border-2 focus:ring-2 focus:ring-blue-600 dark:bg-slate-900"
                          placeholder="John Doe"
                        />
                      </div>
                      ...
                      <div>
                        ...
                        <textarea
                          ...
                          required
                          rows={5}
                          className="w-full px-4 py-3 rounded-lg border-2 focus:ring-2 focus:ring-blue-600 resize-none dark:bg-slate-900"
                          placeholder="Tell us about your project..."
                        />
                      </div>
